...
//crack download link: https://www.phamgiang.pro/apps/ckfinderKey
$config['licenseName'] = 'questionbook.test';
$config['licenseKey'] = 'MYDYGHNCFRNVQG96N63AAR6AUBDGF';
...
$config['backends']['default'] = array(
    'name' => 'default',
    'adapter' => 'local',
    'baseUrl' => app()->runningInConsole() ? '' : url('/') . '/userfiles/',
